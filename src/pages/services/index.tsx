      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['description.contains', 'service_location.contains', 'service_provider.contains'],
          ...params.filters,
        },
        'service',
      ),
  ...
  const columns: ColumnType[] = [
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.service_date ? format(record?.service_date, 'dd-MM-yyyy') : '',
    },
    { id: 'description', header: 'Description', accessorKey: 'description' },
    { id: 'service_location', header: 'Service Location', accessorKey: 'service_location' },
    { id: 'service_provider', header: 'Service Provider', accessorKey: 'service_provider' },

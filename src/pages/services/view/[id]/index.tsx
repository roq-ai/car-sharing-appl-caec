          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem
                  label="Service Date"
                  text={data?.service_date ? format(data?.service_date, 'dd-MM-yyyy') : ''}
                />

                <FormListItem label="Description" text={data?.description} />

                <FormListItem label="Service Location" text={data?.service_location} />

                <FormListItem label="Service Provider" text={data?.service_provider} />

  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the future of mobility with Car Sharing Application. Your journey to efficient and sustainable transportation starts here."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the future of mobility with Car Sharing Application. Your journey to efficient and sustainable transportation starts here.`}
            </Text>
            <Box
